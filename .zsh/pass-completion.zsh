...
compdef _pass pass
zstyle ':completion::complete:pass::' prefix "$HOME/.password-store/primary"
pass() {
  PASSWORD_STORE_DIR=$HOME/.password-store/primary PASSWORD_STORE_ENABLE_EXTENSIONS=true /opt/homebrew/bin/pass $@
}

compdef _pass wpass
zstyle ':completion::complete:wpass::' prefix "$HOME/.password-store/work"
wpass() {
  PASSWORD_STORE_DIR=$HOME/.password-store/work PASSWORD_STORE_ENABLE_EXTENSIONS=true /opt/homebrew/bin/pass $@
}
