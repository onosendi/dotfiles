...
set cmdheight=2                  " Hiehgt of the command bar.
set noswapfile                   " Do not create swap file.
set nobackup                     " Do not backup.
set nowritebackup                " Prevent automatic write backup before overwriting file.
...
highlight Normal ctermbg=none    " Make vim background transparent.
highlight NonText ctermbg=none   " Help make other 'nothing exist' region transparent. 
...
hi Normal ctermbg=NONE             " Use iterm2 background

" Status line ----------------------------------------------------------------
set laststatus=2                 " Always show the status line.

" How the status line should be displayed.
...
set shiftwidth=4                " How many columns of text is indented with the reindent operations (<< and >>).
set softtabstop=4               " How many columns vim uses when you hit Tab in insert mode.
set nowrap                      " Do not wrap lines.
set whichwrap+=<,>,h,l,[,]      " Wrap and beginning and end of lines. (< > are the cursor keys used in 
...
au BufNewFile,BufRead *.php,*.html,*.css set 
    \ tabstop=2
    \ softtabstop=2
    \ shiftwidth=2
